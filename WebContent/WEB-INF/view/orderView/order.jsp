...
<jsp:setProperty name= "adminBean" property ="stylePage" value="/WEB-INF/view/orderView/orderStyle.jsp" />
<jsp:setProperty name= "adminBean" property ="contentPage" value="/WEB-INF/view/orderView/orderBody.jsp" />
<jsp:setProperty name= "adminBean" property ="scriptPage" value="/WEB-INF/view/orderView/orderScript.jsp" />
