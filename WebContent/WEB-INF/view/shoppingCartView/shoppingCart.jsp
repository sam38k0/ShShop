...
<jsp:setProperty name= "adminBean" property ="stylePage" value="/WEB-INF/view/shoppingCartView/shoppingCartStyle.jsp" />
<jsp:setProperty name= "adminBean" property ="contentPage" value="/WEB-INF/view/shoppingCartView/shoppingCartBody.jsp" />
<jsp:setProperty name= "adminBean" property ="scriptPage" value="/WEB-INF/view/shoppingCartView/shoppingCartScript.jsp" />
