...
<jsp:setProperty name= "adminBean" property ="stylePage" value="/WEB-INF/view/searchView/searchProductsStyle.jsp" />
<jsp:setProperty name= "adminBean" property ="contentPage" value="/WEB-INF/view/searchView/searchProductsBody.jsp" />
<jsp:setProperty name= "adminBean" property ="scriptPage" value="/WEB-INF/view/searchView/searchProductsScript.jsp" />
