...
public class KeywordsGuesserTest {
	...
	public void testWhiteSpaceAnalyzer() throws IOException {
		StringReader stringReader = new StringReader("키워드1 키워드2  키워드3     키워드4.");
	...
	public void testGet() throws IOException {
		String result = KeywordGuesser.getKeywordsWithoutWhiteSpace("키워드1 키워드2  키워드3     키워드4.","|");
		assertTrue("",result.equals("키워드1|키워드2|키워드3|키워드4."));
	}
}