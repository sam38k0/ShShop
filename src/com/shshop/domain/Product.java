...
public class Product implements Serializable {
	...
	public Product(Integer userId, String name, int price, int stock, int translation, int connection, String tag, String description,
			int searchingCount, boolean onSale, boolean onOpen, boolean outOfStock) {
		this.userId = userId;
		this.name = name;
		this.price = price;
		this.stock = stock;
	...
	public boolean equals(Object object) {
		...
		if (object != null && object instanceof Product) {
			...
			sameSame = (this.getName().equalsIgnoreCase(product.getName()) && this.getUserId().equals(product.getUserId()) && this.getPrice() == product
					.getPrice());
		}
