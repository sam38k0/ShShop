...
import com.shshop.helper.SearchResultParam;
...
public class ProductService {
	...
	public CommandResult setSearchedProductDatas() {
		// [TODO]:당장은 데이터가 없으므로 임의로 데이터를 만들어서 처리함.
		// 1. 키워드로 검색 할 수 있는 모든 쿼리
		// 2. 다중키워드인 경우 쿼리 ( 동적 SQL 사용해야 함 )
		...
		request.setAttribute("totalSearchingCount", searchResults.size());
